                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            <table class="table table-hover demo-table-search table-responsive-block" id="tableWithSearch" >
                                <thead>
                                    <tr>
                                        <th class ="text-center bg-complete text-white" style="width:33%">fecha</th>
                                        <th class ="text-center bg-complete text-white" style="width:33%">importe</th>
                                        <th class ="text-center bg-complete text-white" style="width:33%">comentario</th>                            
                                    </tr>
                                </thead>
                                <tbody><?php $total = 0; ?>
                                    <?php if (count($payments)>0): ?>
