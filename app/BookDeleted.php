...
class BookDeleted extends Model
{
    ...
    public static function replicateFromBook($book)
    {
        $bookDeleted = new \App\BookDeleted();
        $bookDeleted->id            = $book->id;
        $bookDeleted->user_id       = $book->user_id;
        $bookDeleted->customer_id   = $book->customer_id;
        $bookDeleted->room_id       = $book->room_id;
        $bookDeleted->start         = $book->start;
        $bookDeleted->finish        = $book->finish;
        $bookDeleted->comment       = $book->comment;
        $bookDeleted->book_comments = $book->book_comments;
        $bookDeleted->type_book     = $book->type_book;
        $bookDeleted->pax           = $book->pax;
        $bookDeleted->real_pax      = $book->pax;
        $bookDeleted->nigths        = $book->nigths;
        $bookDeleted->agency        = $book->agency;
        $bookDeleted->PVPAgencia    = $book->PVPAgencia;
        $bookDeleted->sup_limp      = $book->sup_limp;
        $bookDeleted->cost_limp     = $book->cost_limp;
        $bookDeleted->sup_park      = $book->sup_park;
        $bookDeleted->cost_park     = $book->cost_park;
        $bookDeleted->type_park     = $book->type_park;
        $bookDeleted->type_luxury   = $book->type_luxury;
        $bookDeleted->sup_lujo      = $book->sup_lujo;
        $bookDeleted->cost_lujo     = $book->cost_lujo;
        $bookDeleted->cost_apto     = $book->cost_apto;
        $bookDeleted->cost_total    = $book->cost_total;
        $bookDeleted->total_price   = $book->total_price;
        $bookDeleted->real_price    = $book->real_price;
        $bookDeleted->total_ben     = $book->total_ben;
        $bookDeleted->extraPrice    = $book->extraPrice;
        $bookDeleted->extraCost     = $book->extraCost;
        $bookDeleted->inc_percent   = $book->inc_percent;
        $bookDeleted->ben_jorge     = $book->ben_jorge;
        $bookDeleted->ben_jaime     = $book->ben_jaime;
