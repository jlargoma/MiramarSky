...
//              $message->to('pingodevweb@gmail.com');
    ...
    \App\BookLogs::saveLog($book->id,$book->room_id,$book->customer->email,'SMS_Partee_msg',$subject,$message);
...
//    11 => 'blocked-ical',
    ...
    if (count($oBooks)>0){
      ...
      $this->sLog->info('Partee: No hay reservas entre '.date('Y-m-d').' y '.date('Y-m-d', strtotime('+2 days')));
    }
  }
}
