...
{
  public static function createOrEdit($usr,$site_id,$bookID=null){
    if (isset($usr)){
      $email = isset($usr['c_email']) ? trim($usr['c_email']) : '';
...
//      var_dump($usr,$site_id,$bookID);
      if($bookID)  $customer->book_id = $bookID;
