...
class LiquidacionController_1 extends AppController {
...
//      $totales["beneficio"] += $book->profit;
      ...
      //SUMMARY
      /* Nº inquilinos */
      $summary['pax'] += $book->pax;
      /* Dias ocupados */
      $summary['nights'] += $book->nigths;
    ...
    $summary['total'] = $t_books;
    $summary['total_pvp'] = $totales["total"];
    $summary['benef'] = round($totales["beneficio"],2);
    if($t_books>0){
      $summary['vta_agency'] = round(($vta_agency / $t_books) * 100);
      $summary['vta_prop'] = 100-$summary['vta_agency'];    
      $summary['nights-media'] = ($summary['nights']>0) ? ceil($summary['nights']/$t_books) : 0;
    }
