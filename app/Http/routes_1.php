...
Route::post('admin/reservas/stripe/save/fianza', [
    'middleware' => 'auth',
    'uses'       => 'StripeController@fianza'
]);
Route::post('admin/reservas/stripe/pay/fianza', [
    'middleware' => 'auth',
    'uses'       => 'StripeController@payFianza'
]);
...
Route::get('admin/reservas', [
    'middleware' => 'authSubAdmin',
    'uses'       => 'BookController@index'
])->name('dashboard.planning');

Route::get('admin/reservas/emails/{id}', [
    'middleware' => 'authSubAdmin',
    'uses'       => 'BookController@emails'
]);
Route::get('admin/reservas/new', [
    'middleware' => 'auth',
    'uses'       => 'BookController@newBook'
]);
Route::get('admin/reservas/delete/{id}', [
    'middleware' => 'auth',
    'uses'       => 'BookController@delete'
]);
Route::get('admin/reservas/update/{id}', [
    'middleware' => 'auth',
    'uses'       => 'BookController@update'
])->name('book.update');
Route::post('admin/reservas/saveUpdate/{id}', [
    'middleware' => 'auth',
    'uses'       => 'BookController@saveUpdate'
]);
Route::get('admin/reservas/changeBook/{id}', [
    'middleware' => 'auth',
    'uses'       => 'BookController@changeBook'
]);
...
Route::get('admin/reservas/ansbyemail/{id}', [
    'middleware' => 'auth',
    'uses'       => 'BookController@ansbyemail'
]);
Route::post('admin/reservas/sendEmail', [
    'middleware' => 'auth',
    'uses'       => 'BookController@sendEmail'
]);
Route::get('admin/reservas/sendJaime', [
    'middleware' => 'authSubAdmin',
    'uses'       => 'BookController@sendJaime'
]);
Route::get('admin/reservas/saveCobro', [
    'middleware' => 'authSubAdmin',
    'uses'       => 'BookController@saveCobro'
]);
Route::get('admin/reservas/deleteCobro/{id}', [
    'middleware' => 'authSubAdmin',
    'uses'       => 'BookController@deleteCobro'
]);
Route::get('admin/reservas/saveFianza', [
    'middleware' => 'auth',
    'uses'       => 'BookController@saveFianza'
]);
Route::get('admin/reservas/reserva/{id}', [
    'middleware' => 'auth',
    'uses'       => 'BookController@tabReserva'
]);
Route::get('admin/reservas/cobrar/{id}', [
    'middleware' => 'auth',
    'uses'       => 'BookController@cobroBook'
]);

Route::get('admin/reservas/search/searchByName', 'BookController@searchByName');
Route::get('admin/reservas/api/getTableData', [
    'middleware' => 'auth',
    'uses'       => 'BookController@getTableData'
]);
Route::get('admin/reservas/api/lastsBooks', [
    'middleware' => 'auth',
    'uses'       => 'BookController@getLastBooks'
]);
Route::get('admin/reservas/api/calendarBooking', [
    'middleware' => 'auth',
    'uses'       => 'BookController@getCalendarBooking'
]);
Route::get('admin/reservas/api/alertsBooking', [
    'middleware' => 'auth',
    'uses'       => 'BookController@getAlertsBooking'
]);
Route::get('admin/api/reservas/getDataBook', [
    'middleware' => 'auth',
    'uses'       => 'BookController@getAllDataToBook'
]);
Route::get('admin/reservas/api/sendSencondEmail', [
    'middleware' => 'auth',
...
Route::get('admin/usuarios/update/{id}', [
    'middleware' => 'authAdmin',
    'uses'       => 'UsersController@update'
]);
Route::post('admin/usuarios/saveAjax', [
    'middleware' => 'authAdmin',
    'uses'       => 'UsersController@saveAjax'
]);
Route::post('admin/usuarios/saveupdate', [
    'middleware' => 'authAdmin',
...
Route::get('admin/usuarios/delete/{id}', [
    'middleware' => 'authAdmin',
    'uses'       => 'UsersController@delete'
]);
Route::post('admin/usuarios/search', [
    'middleware' => 'authAdmin',
...
Route::get('admin/clientes/update', [
    'middleware' => 'auth',
    'uses'       => 'CustomersController@update'
]);
Route::get('admin/clientes/save', [
    'middleware' => 'auth',
...
Route::get('admin/clientes/export-excel', [
    'middleware' => 'auth',
    'uses'       => 'CustomersController@createExcel'
]);
Route::get('admin/customers/importExcelData', [
    'middleware' => 'auth',
    'uses'       => 'CustomersController@createExcel'
]);
Route::get('admin/clientes/delete/{id}', [
    'middleware' => 'auth',
...
// seasons
Route::get('admin/temporadas', [
    'middleware' => 'authAdmin',
    'uses'       => 'SeasonsController@index'
]);
Route::get('admin/temporadas/new', [
    'middleware' => 'authAdmin',
    'uses'       => 'SeasonsController@newSeasons'
]);
Route::get('admin/temporadas/new-type', [
    'middleware' => 'authAdmin',
    'uses'       => 'SeasonsController@newTypeSeasons'
]);
Route::get('admin/temporadas/update/{id}', [
    'middleware' => 'authAdmin',
    'uses'       => 'SeasonsController@update'
]);
Route::post('admin/temporadas/update/{id}', [
    'middleware' => 'authAdmin',
    'uses'       => 'SeasonsController@update'
]);
Route::post('admin/temporadas/saveupdate', [
    'middleware' => 'authAdmin',
    'uses'       => 'SeasonsController@saveUpdate'
]);
Route::post('admin/temporadas/create', [
    'middleware' => 'authAdmin',
    'uses'       => 'SeasonsController@create'
]);
Route::post('admin/temporadas/create-type', [
    'middleware' => 'authAdmin',
    'uses'       => 'SeasonsController@createType'
]);
Route::get('admin/temporadas/delete/{id}', [
    'middleware' => 'authAdmin',
    'uses'       => 'SeasonsController@delete'
]);

// Pagos
Route::get('admin/pagos', [
    'middleware' => 'authAdmin',
    'uses'       => 'PaymentsController@index'
]);
Route::get('admin/pagos/create', [
    'middleware' => 'authAdmin',
    'uses'       => 'PaymentsController@create'
]);
Route::get('admin/pagos/update', [
    'middleware' => 'authAdmin',
    'uses'       => 'PaymentsController@update'
]);

// Pagos-Propietarios
Route::get('admin/pagos-propietarios', [
    'middleware' => 'authAdmin',
    'uses'       => 'PaymentsProController@index'
]);
Route::post('admin/pagos-propietarios/create', [
    'middleware' => 'authAdmin',
    'uses'       => 'PaymentsProController@create'
]);
Route::get('admin/pagos-propietarios/update/{id}/{month?}', [
    'middleware' => 'authAdmin',
    'uses'       => 'PaymentsProController@update'
]);
...
Route::get('admin/pagos-propietarios/get/historic_production/{room_id}', [
    'middleware' => 'authAdmin',
    'uses'       => 'PaymentsProController@getHistoricProduction'
]);


//Liquidacion
Route::get('admin/liquidacion', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@index'
]);
Route::get('admin/liquidacion-apartamentos', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@apto'
]);
Route::get('admin/liquidacion/export/excel', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@exportExcel'
]);

Route::get('admin/gastos/{year?}', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@gastos'
]);
Route::post('admin/gastos/create', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@gastoCreate'
]);
Route::get('/admin/gastos/getTableGastos', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@getTableGastos'
]);

Route::get('admin/gastos/update/{id}', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@updateGasto'
]);
Route::get('/admin/gastos/getHojaGastosByRoom/{year?}/{id}', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@getHojaGastosByRoom'
]);
...
Route::get('admin/ingresos', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@ingresos'
]);
Route::post('admin/ingresos/create', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@ingresosCreate'
]);
...
Route::get('admin/caja/getTableMoves/{year?}/{type}', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@getTableMoves'
]);
Route::post('admin/cashBox/create', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@cashBoxCreate'
]);
...
Route::get('admin/banco', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@bank'
]);
Route::get('admin/banco/getTableMoves/{year?}/{type}', [
    'middleware' => 'authAdmin',
    'uses'       => 'LiquidacionController@getTableMovesBank'
]);
...
Route::get('/admin/rules/stripe/update', [
    'middleware' => 'authAdmin',
    'uses'       => 'RulesStripeController@update'
]);
...
Route::get('admin/facturas/', [
    'middleware' => 'authAdmin',
    'uses'       => 'InvoicesController@index'
]);
Route::get('admin/facturas/ver/{id}', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@view'
]);
Route::get('admin/facturas/descargar/{id}', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@download'
]);
Route::get('admin/facturas/descargar-todas', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@downloadAll'
]);
Route::get('admin/facturas/descargar-todas/{year}/{id}', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@downloadAllProp'
]);

Route::get('admin/facturas/solicitudes/{year?}', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@solicitudes'
]);
Route::get('admin/facturas/isde/create', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@createIsde'
]);
Route::post('admin/facturas/isde/create', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@createIsde'
]);

Route::get('admin/facturas/isde/{year?}', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@isde'
]);
Route::get('admin/facturas/isde/ver/{id}', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@viewIsde'
]);
Route::get('admin/facturas/isde/descargar/{id}', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@downloadIsde'
]);
Route::get('admin/facturas/isde/delete/{id}', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@deleteIsde'
]);
Route::get('admin/facturas/isde/editar/{id}', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@updateIsde'
]);
Route::post('admin/facturas/isde/saveUpdate', [
    'middleware' => 'auth',
    'uses'       => 'InvoicesController@saveUpdate'
]);

//Facturas
Route::get('admin/encuestas/{year?}/{apto?}', [
    'middleware' => 'authAdmin',
    'uses'       => 'QuestionsController@admin'
]);
...
// AUX PROPIETARIOS 
Route::get('admin/propietarios/dashboard/{name?}/{year?}', [
    'middleware' => 'authAdmin',
    'uses'       => 'OwnedController@index'
]);
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/admin/rooms/cupos', 'RoomsController@getCupos');
    Route::get('/admin/apartamentos/fast-payment', 'RoomsController@updateFastPayment');
    Route::get('/admin/apartamentos/update-order-payment', 'RoomsController@updateOrderFastPayment');
    Route::get('/admin/sizeAptos/update-num-fast-payment', 'RoomsController@updateSizeAptos');
    ...
    //SETTINGS
    Route::post('/admin/settings/createUpdate', 'SettingsController@createUpdateSetting')
...
Route::post('/ajax/forfaits/deleteRequestPopup', [
    'middleware' => 'authAdmin',
    'uses'       => 'FortfaitsController@deleteRequestPopup'
]);
Route::post('/ajax/booking/getBookingAgencyDetails', [
    'middleware' => 'authAdmin',
...
Route::get('/admin/reservas/ff_change_status_popup/{id}/{status}', [
    'middleware' => 'authAdmin',
    'uses'       => 'BookController@updateBookFFStatus'
]);
...
Route::group(['middleware' => 'authAdmin'], function () {
    ...
    Route::post('/proccess/payment/book/{id}/{payment?}', 'PaylandsController@processPaymentBook')->name('payland.proccess.payment.book');

    Route::get('/proccess/payment/book/customer/{id}/{payment?}', 'PaylandsController@processPaymentBook')->name('payland.proccess.payment.book.customer');
    Route::post('/proccess/payment/book/customer/{id}/{payment?}', 'PaylandsController@processPaymentBook')->name('payland.proccess.payment.book.customer');
