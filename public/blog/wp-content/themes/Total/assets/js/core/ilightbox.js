	...
	iLightBox.prototype = {
		...
		normalizeItems: function() {
			...
			$.each(iL.items, function(key, val) {
				...
				options.iframeType = options.iframeType || null, // ADDED BY WPEXPLORER
				options.skin = options.skin || iL.options.skin,
				options.width = options.width || iL.options.width, // ADDED BY WPEXPLORER
				options.height = options.height || iL.options.height, // ADDED BY WPEXPLORER
