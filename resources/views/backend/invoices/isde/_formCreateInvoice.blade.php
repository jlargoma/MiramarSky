    ...
    <div class="container-fluid padding-25 sm-padding-10 bg-white">
        <div class="container clearfix">
            ...
            <div class="col-md-6 col-xs-12 text-left push-30">
                <h2 class="font-w300" style="margin: 0">DATOS PARA LA  <span class="font-w800">FACTURA/SOLICITUD  </span></h2>
            </div>

            <div class="col-xs-12 bg-white">
                <form action="{{ url('/admin/facturas/isde/create') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-xs-12 push-20">
                            ...
                            <input type="text" name="nif_business" class="form-control" >
                        </div>
                        <div class="col-md-4 col-xs-12 push-20">
                            <label for="">Dirección emisor</label>
                            <input type="text" name="address_business" class="form-control" >
                        </div>
                        <div class="col-md-4 col-xs-12 push-20">
                            <label for="">Telefono emisor</label>
                            <input type="number" name="phone_business" class="form-control" >
                        </div>
                        <div class="col-md-4 col-xs-12 push-20">
                            <label for="">C. postal emisor</label>
                            <input type="text" name="zip_code_business" class="form-control" >
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-xs-12 push-20">
                            ...
                            <input type="text" name="fechas" class="form-control dateRange" id="dateRange" name="dateRange" required="" style="cursor: pointer; text-align: center;min-height: 28px; width: 85%;float: left;" readonly="">
                        </div>
                        ...
                        <div class="col-md-2 col-md-offset-1 col-xs-12 push-20">
                            <input type="radio" name="status" value="1" > ACEPTAR <br>
                            <input type="radio" name="status" value="0" > RECHAZAR
                        </div>
                    </div>
