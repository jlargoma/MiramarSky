        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="col-md-4 m-t-20">
                    <div class="col-md-3">
                        <a class="btn btn-success btn-cons text-white" href="{{ url('') }}/<?php echo str_replace('descuentos', 'operativa', Request::path()) ?>"  >Opertaiva</a>
                    </div>
                    <div class="col-md-3">
                        <a class="btn btn-success btn-cons text-white" href="{{ url('') }}/<?php echo str_replace('descuentos', 'tarifas', Request::path()) ?>" >Tarifas</a>
                    </div>
                    <div class="col-md-3">
                        <a class="btn btn-success btn-cons text-white" href="{{ url('') }}" disabled>Descuentos</a>
                    </div>
                    <div class="col-md-3">
                        <a class="btn btn-success btn-cons text-white" href="{{ url('') }}/<?php echo str_replace('descuentos', 'fiscalidad', Request::path()) ?>">Fiscalidad</a>
                    </div>
                ...
                <div class="col-md-1 pull-right">
                    <div class="col-md-3 m-t-20">
                        ...
                        <a class="btn btn-success btn-cons text-white" href="{{ url('') }}/<?php echo str_replace('operativa', '', Request::path()) ?>">Volver</a>
                    </div>
                </div>        
            </div>
