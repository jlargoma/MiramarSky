    ...
    <div class="row">
        <div class="col-md-12 text-center">
            <div class="col-md-4 m-t-20">
                <div class="col-md-3">
                    <a class="btn btn-danger btn text-white" href="{{ url('') }}/<?php echo str_replace('fiscalidad', 'operativa', Request::path()) ?>"  >Opertaiva</a>
                </div>
                <div class="col-md-3">
                    <a class="btn btn-danger btn text-white" href="{{ url('') }}/<?php echo str_replace('fiscalidad', 'tarifas', Request::path()) ?>" >Tarifas</a>
                </div>
                <div class="col-md-3">
                    <a class="btn btn-danger btn text-white" href="{{ url('') }}/<?php echo str_replace('fiscalidad', 'descuentos', Request::path()) ?>">Descuentos</a>
                </div>
                <div class="col-md-3">
                    <a class="btn btn-danger btn text-white" href="{{ url('') }}" disabled>Fiscalidad</a>
                </div>
            ...
            <div class="col-md-1 pull-right">
                <div class="col-md-3 m-t-20">
                    ...
                    <a class="btn btn-danger btn text-white" href="{{ url('') }}/<?php echo str_replace('fiscalidad', '', Request::path()) ?>">Volver</a>
                </div>
            </div>        
        </div>
