        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="col-md-4 m-t-20">
                    <div class="col-md-3">
                        <a class="btn btn-success btn text-white" href="{{ url('') }}" disabled >Operativa</a>
                    </div>
                    <div class="col-md-3">
                        <a class="btn btn-success btn text-white" href="{{ url('') }}/<?php echo str_replace('operativa', 'tarifas', Request::path()) ?>">Tarifas</a>
                    </div>
                    <div class="col-md-3">
                        <a class="btn btn-success btn text-white" href="{{ url('') }}/<?php echo str_replace('operativa', 'descuentos', Request::path()) ?>">Descuentos</a>
                    </div>
                    <div class="col-md-3">
                        <a class="btn btn-success btn text-white" href="{{ url('') }}/<?php echo str_replace('operativa', 'fiscalidad', Request::path()) ?>">Fiscalidad</a>
                    </div>
                ...
                <div class="col-md-1 pull-right">
                    <div class="col-md-3 m-t-20">
                        ...
                        <a class="btn btn-success btn text-white" href="{{ url('') }}/<?php echo str_replace('operativa', '', Request::path()) ?>">Volver</a>
                    </div>
                </div>       
            </div>
...
<?php else: ?>
    <div class="container-fluid padding-10 sm-padding-10">
        <div class="row">
            <div class="col-md-12 text-left push-20">
                ...
                <div class="col-md-4 m-t-20">
                    <div class="col-xs-6 push-10">
                        <a class="btn btn-success btn-cons text-white" href="{{ url('') }}" disabled >Operativa</a>
                    </div>
                    <div class="col-xs-6 push-10">
                        <a class="btn btn-success btn-cons text-white" href="{{ url('') }}/<?php echo str_replace('operativa', 'tarifas', Request::path()) ?>">Tarifas</a>
                    </div>
                    <div class="col-xs-6 push-10">
                        <a class="btn btn-success btn-cons text-white" href="{{ url('') }}/<?php echo str_replace('operativa', 'descuentos', Request::path()) ?>">Descuentos</a>
                    </div>
                    <div class="col-xs-6 push-10">
                        <a class="btn btn-success btn-cons text-white" href="{{ url('') }}/<?php echo str_replace('operativa', 'fiscalidad', Request::path()) ?>">Fiscalidad</a>
                    </div>
            ...
            <div class="col-md-12">
                <div align="center"><h2 class="font-s20"><strong>OPERATIVA DE FUNCIONAMIENTO</strong></h2></div>
