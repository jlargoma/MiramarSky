<div class="row">
    <div class="col-md-7">
        <div class="row btn-mb-1">
            ...
            <button class="btn btn-success btn-orange <?php if($CustomersRequest>0) echo 'btn-alarms';?>" id="btnCustomersRequest">
            ...
            <button class="btn btn-success btn-orange <?php if($CustomersRequest>0) echo 'btn-alarms'; ?>" id="btnBookingsWithoutCvc">
