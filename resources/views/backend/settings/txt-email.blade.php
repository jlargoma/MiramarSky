...
<div class="container-fluid padding-25 sm-padding-10">
  ...
  <div class="row">
    ...
    <div class="row ">
      ...
      <form method="POST" action="{{route('settings.msgs.upd','es')}}">
          ...
          <h3 class="subtit">Español</h3>
            ...
            <div class="tab-container">
              ...
              <div class="rvn_2_content">
                <textarea class="ckeditor" name="{{$key.'_ota'}}" id="{{$key.'_ota'}}" rows="20" cols="80">{{$data['es_ota']}}</textarea>
              </div>
            </div>
            @else
            <textarea class="ckeditor" name="{{$key}}" id="{{$key}}" rows="20" cols="80">{{$data['es']}}</textarea>
        ...
        <div class="text-center">
          ...
          <?php $k_en = $key.'_en'; ?>
            ...
            <div class="tab-container">
              ...
              <div class="rvn_2_content">
                <textarea class="ckeditor" name="{{$key.'_ota_en'}}" id="{{$key.'_ota_en'}}" rows="20" cols="80">{{$data['en_ota']}}</textarea>
              </div>
            </div>
            @else
            <textarea class="ckeditor" name="{{$k_en}}" id="{{$k_en}}" rows="20" cols="80">{{$data['en']}}</textarea>
