    ...
    <div class="row">
      <div class="col-md-4 col-sm-6 col-xs-12 few-words-colmun">
        <div class="single-item">
          ...
          <div class="icon-box">
            <img class="loadJS" src="/img/firts-min.png" data-src="{{ getCloudfl('/frontend/images/home/icon-forfait-1.png')}}" style="width: 90px;min-width: auto;">
          </div>
      ...
      <div class="col-md-4 col-sm-6 col-xs-12 few-words-colmun">
        <div class="single-item">
          <a href="{{env('FF_PAGE')}}" title="Ir a Forfait" target="_black">
          <div class="icon-box">
            <img class="loadJS" src="/img/firts-min.png" data-src="{{ getCloudfl('/frontend/images/home/icon-forfait-3.png')}}" style="width: 90px;min-width: auto;">
          </div>
          <div class="single-content">
