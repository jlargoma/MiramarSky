        ...
        <div class="container container-mobile clearfix push-0">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center" >
                <p class="texto-aparamento " style="text-align: justify;color:black;font-size:16px;padding:0px 30px" >
                    <b>1. Hora de Entrada (Check in): La entrega de llaves la realizamos en el propio edifico entre las 17:30 a 19.30 Horas</b><br><br>
                    ...
                    Nos sabe muy mal tener que cobrarte este recargo, Esperamos que entiendas que es solo para compensar el tiempo de espera de la persona que te tiene que entregar las llaves.<br><br>

                    <b>2. Hora de Salida (Checkout): La vivienda deberá ser desocupada antes de las 11,59h A.M.</b> (de lo contrario se podrá cobrará una noche más de alquiler apartamento según tarifa apartamento y ocupación.<br><br>
                    ...
                    <b>4. Señal de la reserva: Para realizar una reserva debe de abonar el 50% del importe total de la
                        reserva.</b> En caso de cancelación la empresa tratará de buscar nuevos huéspedes y en ese caso te devolveremos íntegramente el dinero que tu has adelantado. Cuanto más tiempo nos des para hacerlo, más fácil es que lo consigamos.<br><br>

                    Si no conseguimos una nueva reserva para tus fechas, la empresa tiene el derecho a no devolver la señal, sea la cancelación por el motivo que sea, aunque lo intentaremos siempre.<br><br>
                    ...
                    <b>6. Piscina:</b> El horario de la piscina es de 16:30 a 20 h (salvo los martes cerrado por descanso del conserje). La piscina solo está abierta desde el 15 de diciembre hasta el 1 de mayo<br><br>

                    <b>7. Meteorología y estado de pistas:</b> Las condiciones del alquiler de la vivienda son
                    ...
                    <b>8. Nº de personas:</b> El apartamento no podrá ser habitado por más personas de las camas que
                    dispone.<br><br>

                    <b>9. No se admiten animales.</b><br><br>


                    <b>10. Sabanas y Toallas están incluidas en todas las reservas.</b><br><br>


                    <b>11.</b> A partir de las 23 horas se ruega guardar silencio en los apartamentos y en las zonas
                    comunes, por respeto al sueño y a la tranquilidad de los demás inquilinos y propietarios del edificio Miramarski.<br><br>


                    <b>12. Condiciones del apartamento en el Checkout:</b> El alojamiento se deberá entregar antes de las 12:00am con un estado de limpieza aceptable, Vajilla limpia y recogida, Muebles de cama en la misma posición que se entregaron, Sin basuras en el apartamento, Nevera vacía (sin comida sobrante), Edredones doblados en los armarios.<br><br>

                    Si algunos de estos requisitos no se cumplen podría conllevar la perdida de la fianza, total o parcialmente.<br><br>


                    <b>13. Cancelaciones y modificaciones:</b><br><br>

                    Para la cancelación de una reserva debe ponerse en contacto por email con nosotros <a href="mailto:reservas@apartamentosierranevada.net">reservas@apartamentosierranevada.net</a>
                    .<br><br>

                    La política de cancelaciones es la siguiente:<br><br>

                    - Para cancelaciones antes de 60 días de la fecha de llegada, 0% de penalización sobre el importe total de la estancia.<br><br>
                    ...
                    <b>15. Leyes aplicables.</b>
                    Este contrato está realizado en España, por lo que las leyes españolas son de aplicación. Las partes contractuales se someten a la jurisdicción y competencia de Granada, con la exclusión de las cortes de cualquier otro país.<br><br>
                </p>
            </div>
    </section>
