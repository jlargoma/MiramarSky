<?php if (!$mobile->isMobile()): ?>
	...
	<p class="font-s16 ls-15 miramar font-w300 text-justify push-30">
		<ul class="properties" >
			...
			<li>
				<a class="property">
					<img src="{{ asset('/img/miramarski/iconos/small/huespedes.png') }}" /> 8/14 Huéspedes 
				</a>
			</li>
			<li>
				<a class="property">
					<img src="{{ asset('/img/miramarski/iconos/small/dormitorios.png') }}" /> 3 Dormitorios 
				</a>
			</li>
			<li>
				<a class="property">
					<img src="{{ asset('/img/miramarski/iconos/small/apto.png') }}" /> 8/10 Camas 
				</a>
			</li>
			<li>
				<a class="property">
					...
					<div class="col-xs-12">
						<p class="font-s16 ls-15 miramar font-w300 text-justify push-30">
							<ul class="properties" >
								...
								<li>
									<a href="#" class="property">
										<img src="{{ asset('/img/miramarski/iconos/small/huespedes.png') }}" /> 8/14 pers 
									</a>
								</li>
								<li>
									<a href="#" class="property">
								...
								<li>
									<a href="#" class="property">
										<img src="{{ asset('/img/miramarski/iconos/small/apto.png') }}" /> 10 Camas 
									</a>
								</li>
								<li>
									<a href="#" class="property">
								...
								<li>
									<a href="#" class="property">
										<img src="{{ asset('/img/miramarski/iconos/small/secador.png') }}" /> Secador
									</a>
								</li>
								<li>
									<a href="#" class="property">
								...
								<li>
									<a href="#" class="property">
										<img src="{{ asset('/img/miramarski/iconos/small/mascotas.png') }}" /> NO Mascotas 
									</a>
								</li>
							</ul>
						</p>
