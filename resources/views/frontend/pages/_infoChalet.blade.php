<?php if (!$mobile->isMobile()): ?>
	<p class="push-10 font-s16 miramar font-w300 text-justify" style="letter-spacing: -1px; line-height: 1.3"><b>Chalet dos dormitorios</b>, <b><u>tiene capacidad para alojar entre 6 y 8 personas</u></b> según cada caso. <br><br>
	...
	<p class="push-10 font-s16 miramar font-w300 text-justify" style="letter-spacing: -1px; line-height: 1.3">
		...
		<b><u>Gimnasio, 2 plazas de parking cubierto, taquilla guardaesquis, acceso directo a las pistas.</u></b><br><br>
		...
		<b><u>Está a pie de Pistas</u></b>,  sales esquiando desde el propio chealet sin tener que coger ningún remonte. Se encuentran situados en la zona baja de la estación, <b> a 5 minutos andando de Pradollano (  plaza de Andalucía)</b>, zona donde se encuentran todos los restaurantes y tiendas de la estación.<br><br>
...
<?php else: ?>
	<div class="container container-mobile clearfix" style="padding: 0">
		
		<div class="tabs tabs-alt tabs-tb clearfix ui-tabs ui-widget ui-widget-content ui-corner-all push-0" id="tab-8">

			<ul class="tab-nav clearfix ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
				<li class="ui-state-default ui-corner-top ui-tabs-active ui-state-active" role="tab" tabindex="0" aria-controls="tabs-29" aria-labelledby="ui-id-13" aria-selected="true" aria-expanded="true">
					<a href="#tabs-29" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-13">
						Información 
					</a>
				</li>
				<li class=" ui-state-default ui-corner-top" role="tab" tabindex="-1" aria-controls="tabs-30" aria-labelledby="ui-id-14" aria-selected="false" aria-expanded="false">
					<a href="#tabs-30" class="ui-tabs-anchor" role="presentation" tabindex="-1" id="ui-id-14">
						Caracteristicas
					</a>		
				</li>
			</ul>
			...
			<div class="tab-container">
				...
				<div class="tab-content clearfix ui-tabs-panel ui-widget-content ui-corner-bottom" id="tabs-29" aria-labelledby="ui-id-13" role="tabpanel" aria-hidden="false">
					<div class="col-xs-12">
							<p class="push-10 font-s16 miramar font-w300 text-justify" style="letter-spacing: -1px; line-height: 1.3"><b>Chalet dos dormitorios</b>, <b><u>tienen capacidad para alojar entre 6 y 8 personas</u></b> según cada caso. <br><br>
								Al entrar a la vivienda se encontrará con un luminoso y amplio salón comedor con cocina<br><br>
							...
							<p class="push-10 font-s16 miramar font-w300 text-justify" style="letter-spacing: -1px; line-height: 1.3">
								<!-- Nuestro edificio (Miramaski) <b>es uno de los más modernos de Sierra Nevada</b>, cuenta con las siguientes comodidades<br><br> -->
								<b><u>Gimnasio, parking cubierto, taquilla guardaesquis, acceso directo a las pistas.</u></b><br><br>
								...
								<b><u>Estas a pie de Pista</u></b>,  sales esquiando desde el propio chalet sin tener que coger ningún remonte. Se encuentran situados en la zona baja de la estación, <b> a 5 minutos andando de Pradollano (  plaza de Andalucía)</b>, zona donde se encuentran todos los restaurantes y tiendas de la estación.<br><br>
