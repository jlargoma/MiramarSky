			...
			<ul>	<!-- SLIDE  -->
				<li class="dark" data-index="rs-35" data-transition="slidehorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="{{asset('/img/miramarski/cama-principal-apartamento-sierra-nevada.jpg')}}"  data-rotate="0"  data-fstransition="slidehorizontal" data-fsmasterspeed="1000" data-fsslotamount="7" data-saveperformance="off"  data-title="One" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					...
					<div class="tp-caption   tp-resizeme"
						id="slide-35-layer-1"
						data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
						data-y="['center','center','center','center']" data-voffset="['-60','0','0','-50']"
						data-fontsize="['100','90','80','60']"
						data-lineheight="['100','90','80','50']"
						...
						data-frames='[{"delay":"+290","split":"chars","splitdelay":0.05,"speed":750,"frame":"0","from":"y:40px;sX:1.5;sY:1.5;opacity:1;fb:20px;","to":"o:1;fb:0;","ease":"Power4.easeOut"},{"delay":"wait","speed":1000,"frame":"999","to":"sX:1;sY:1;opacity:1;fb:10px;","ease":"Power4.easeOut"}]'
						...
						style="z-index: 15; white-space: nowrap; font-size: 110px; line-height: 100px; font-weight: 600; color: rgba(255, 255, 255, 1.00); display: inline-block;font-family:Poppins;letter-spacing:-5px; text-shadow: 1px 1px #000;">Apartamentos de lujo
					</div>
					...
					<div class="tp-caption   tp-resizeme"
						id="slide-35-layer-2"
						data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
						data-y="['center','center','center','center']" data-voffset="['40','40','100','40']"
						...
						style="z-index: 15; white-space: normal; font-size: 30px; line-height: 40px; font-weight: 300; color: rgba(255, 255, 255, 1.00); display: block;font-family:Poppins; text-shadow: 1px 1px #000;">A pie de pista en Sierra Nevada
					</div>
					<div class="tp-caption   tp-resizeme"
						id="slide-35-layer-2"
						data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
						data-y="['center','center','center','center']" data-voffset="['80','80','150','80']"
						data-fontsize="['30','30','40','25']"
						data-lineheight="['40','40','50','30']"
						data-width="['100%','100%','100%','100%']"
						data-height="none"
				...
				<li class="dark" data-index="rs-36" data-transition="slidehorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="{{asset('/img/miramarski/television-chimenea-apartamento-sierra-nevada.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Two" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					...
					<div class="tp-caption   tp-resizeme"
						...
						style="z-index: 15; white-space: nowrap; font-size: 110px; line-height: 100px; font-weight: 600; color: rgba(255, 255, 255, 1.00); display: inline-block;font-family:Poppins;letter-spacing:-5px; text-shadow: 1px 1px #000;">Reformado en 2015
					</div>
					...
					<div class="tp-caption   tp-resizeme"
						id="slide-35-layer-2"
						data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
						data-y="['center','center','center','center']" data-voffset="['0','0','100','40']"
						data-fontsize="['30','30','40','25']"
						data-lineheight="['40','40','50','30']"
						data-width="['100%','100%','100%','100%']"
						data-height="none"
						...
						style="z-index: 15; white-space: normal; font-size: 30px; line-height: 40px; font-weight: 300; color: rgba(255, 255, 255, 1.00); display: block;font-family:Poppins; text-shadow: 1px 1px #000;">El mejor edificio de Sierra Nevada
					</div>
					<div class="tp-caption   tp-resizeme"
						id="slide-35-layer-2"
						data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
						data-y="['center','center','center','center']" data-voffset="['40','40','150','80']"
						data-fontsize="['30','30','40','25']"
						data-lineheight="['40','40','50','30']"
						data-width="['100%','100%','100%','100%']"
						data-height="none"
					...
					<div class="tp-caption   tp-resizeme"
						...
						data-fontsize="['60','30','40','40']"
						data-lineheight="['60','40','50','30']"
						data-width="['100%','100%','100%','100%']"
						data-height="none"
						data-whitespace="normal"
						...
						style="z-index: 15; white-space: normal; font-size: 30px; line-height: 40px; font-weight: 800; color: rgba(255, 255, 255, 1.00); display: block;font-family:Poppins; text-shadow: 1px 1px #000;">¡RESERVA YA!
					</div>
				</li>
				<!-- SLIDE  -->
				<li class="dark" data-index="rs-37" data-transition="slidehorizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="2000"  data-thumb="{{asset('/img/miramarski/salon-miramar-apartamento-sierra-nevada.jpg')}}"  data-rotate="0"  data-saveperformance="off"  data-title="Three" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
					...
					<div class="tp-caption   tp-resizeme"
						...
						style="z-index: 15; white-space: nowrap; font-size: 110px; line-height: 100px; font-weight: 600; color: rgba(255, 255, 255, 1.00); display: inline-block;font-family:Poppins;letter-spacing:-5px; text-shadow: 1px 1px #000;">Servicio de lujo
					</div>
					...
					<div class="tp-caption   tp-resizeme"
						...
						style="z-index: 15; white-space: normal; font-size: 30px; line-height: 40px; font-weight: 300; color: rgba(255, 255, 255, 1.00); display: block;font-family:Poppins; text-shadow: 1px 1px #000;">Vistas maravillosas, Capacidad 8 personas
					</div>
					<div class="tp-caption   tp-resizeme"
						id="slide-35-layer-2"
						data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
						data-y="['center','center','center','center']" data-voffset="['80','80','150','100']"
						data-fontsize="['30','30','40','25']"
						data-lineheight="['40','40','50','20']"
						data-width="['100%','100%','100%','100%']"
						data-height="none"
