							...
							<div class="tp-caption  "
								...
								style="z-index: 7; width: 100%;">
									...
									<div class="tp-caption   tp-resizeme"
										...
										style="z-index: 8; white-space: nowrap; font-size: 110px; line-height: 100px; font-weight: 600; color: rgba(255, 255, 255, 1.00); display: inline-block;font-family:Poppins;letter-spacing:-5px;">Happy Holidays 
									</div>
									...
									<div class="tp-caption   tp-resizeme"
										...
										style="z-index: 9; white-space: normal; font-size: 30px; line-height: 40px; font-weight: 300; color: rgba(255, 255, 255, 1.00); display: block;font-family:Poppins;">Add this Free Snow Add-On to any of your Sliders 
									</div>
								</div>
							</div>
						</div>
