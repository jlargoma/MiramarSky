...
<section id="slider" class="revslider-wrap clearfix" style="max-height: 700px">
            ...
            <ul>    <!-- SLIDE  -->
                <li class="dark" data-index="rs-85" data-transition="fade" data-slotamount="default"
                    ...
                    <div class="tp-caption   tp-resizeme"
                         id="slide-85-layer-3"
                         data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']"
                         data-y="['middle','middle','middle','middle']" data-voffset="['120','120','0','0']"
                         data-fontsize="['25','25','25','20']"
                         data-lineheight="['35','35','35','30']"
                         data-width="['800','800','480','360']"
                         data-height="none"
                         ...
                         style="z-index: 20; text-shadow: 1px 1px #000; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff;font-family:'miramar';">
                        SERVICIO EXCLUSIVO<br>
                        Piscina, gimnasio, parking,guarda esquis, salida directa a las pistas
                    </div>
                    ...
                    <button
                            ...
                            style="z-index: 21; white-space: nowrap; background-color: #59BA41; border-radius: 0; padding: 0 20px!important; font-size: 21px; letter-spacing: -1px;text-shadow: 1px 1px #000;  line-height: 60px;">
                        SOLICITA TU <span
                ...
                <li class="dark" data-index="rs-86" data-transition="fade" data-slotamount="default"
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 19;text-shadow: 1px 1px #000; white-space: nowrap; font-size: 90px; line-height: 90px; font-weight: 800; color: #ffffff;font-family:'miramar';">
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 20;text-shadow: 1px 1px #000; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff;font-family:'miramar';">
                        Uno de los edificios más modernos de Sierra Nevada.
                    </div>
                ...
                <li class="dark" data-index="rs-87" data-transition="fade" data-slotamount="default"
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 20;text-shadow: 1px 1px #000; min-width: 480px; max-width: 480px; white-space: normal; font-size: 25px; line-height: 35px; font-weight: 400; color: #ffffff;font-family:'miramar';">
                        Piscina climatizada, gimnasio, parking cubierto, taquilla guardaesquis, acceso directo a las
                        pistas
                    </div>
            ...
            <ul>    <!-- SLIDE  -->
                <li class="dark" data-index="rs-85" data-transition="fade" data-slotamount="default"
                    ...
                    <div class="tp-caption   tp-resizeme"
                         ...
                         style="z-index: 19; text-shadow: 1px 1px #000; white-space: nowrap; font-size: 60px; line-height: 60px;
						 font-weight:800; color: #ffffff;font-family:'miramar';">APARTAMENTOS DE LUJO
                    </div>
