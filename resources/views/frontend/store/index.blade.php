			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-12">
						...
						<div class="form-group col-sm-12 col-xs-6 col-md-6 col-lg-6">
						    <label for="email">*Email</label>
						    <input type="email" class="sm-form-control"  name="email" id="email" placeholder="Email..." maxlength="40" required="">
						</div>
						<div class="form-group col-sm-12 col-xs-6 col-md-3">
						...
						<div class="form-group col-sm-12 col-xs-6 col-md-3" style="padding: 20px 0;">
