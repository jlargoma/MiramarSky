		...
		<div class="container container-mobile clearfix push-0">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 center" >
				<p class="texto-aparamento " style="text-align: justify;color:black;font-size:16px;padding:0px 30px" >
					...
					<br>
					4. <b>Señal de la reserva</b>: Para realizar una reserva debe de abonar a la cuenta bancaria el <b>50% del importe total de la reserva.</b> En caso de cancelación la señal no se devolverá, sea el motivo que sea.
					...
					<br>
					11.<b>Sabanas y Toallas estan incluidas</b><br>

					<br>
					12. <b>Mantas y Almohada</b>: Si están disponibles en todos los apartamentos.<br>
					...
					<div class="col-xs-10 col-xs-offset-1">
						...
						Si los requisitos no se cumplen,podria conllevar la perdida de la fianza.<br>
					</div>
