		                    				...
		                    				<table width="100%" border="0" cellspacing="0" cellpadding="0">
		                    					...
		                    					<tr>
		                    						<td class="h1" style="padding: 5px 0 0 0;">
		                    							Mensaje desde el formulario de Grupos
		                    						</td>
		                    					</tr>
		                    				</table>
		                    			</td>
		  						...
		  						<table width="100%" border="0" cellspacing="0" cellpadding="0">
		  							<tr>
		  								<td class="h2" style="color: #3F51B5">
		  									Hola Jorge, has recibido una peticion de Grupos con los siquientes datos
		  								</td>
		  							</tr>
		  							<tr>
		  								<td class="bodycopy" style="color: #000">
		  									<b>Nombre: </b> <?php echo $data['name'] ?> <br>
  	 	  									...
  	 	  									<b>Destino:</b> <?php echo $data['destino'] ?> <br>
  	 	  									<b>Personas:</b> <?php echo $data['personas'] ?> <br>
