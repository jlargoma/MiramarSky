...
@section('moreScripts')
 <!--HTML5shiv Js-->
  <script src="{{ assetNew('/frontend/vendor/camera-slider-master/js/modernizr-3.5.0.min.js')}}"></script>
  <!--Camera JS with Required jQuery Easing Plugin-->
  <script src="{{ assetNew('/frontend/vendor/camera-slider-master/js/easing.min.js')}}" type="text/javascript"></script>
  <script src="{{ assetNew('/frontend/vendor/camera-slider-master/js/camera.min.js')}}" type="text/javascript"></script>
  <!-- Bootstrap Js -->
  <script src="{{ assetNew('/frontend/vendor/camera-slider-master/js/bootstrap.min.js')}}" type="text/javascript"></script>
  <!-- Custom JS --->
  <script src="{{ assetNew('/frontend/vendor/camera-slider-master/js/plugins.js')}}"></script>
...
<section class="feature-home">
  <div class="box-feature-home">
    ...
    <div class="bfh-img">
      <figure><img src="{{ assetNew('/frontend/images/home/edificio-1.jpg')}}" alt="Edificio Miramar Ski a pie de pista, zona baja"></figure>
    </div>
  </div>
  <div class="box-feature-home  hidden-mobile">
    <div class="bfh-img">
      <figure><img src="{{ assetNew('/frontend/images/home/edificio-2.jpg')}}" alt=""></figure>
    </div>
    <div class="bfh-text">
      <div class="box right">
      <h3>EXCELENTE SITUACION…..Y ADEMAS  SALES DE CASA ESQUIANDO!!</h3>
    <figure class="mobil"><img src="{{ assetNew('/frontend/images/home/edificio-2.jpg')}}" alt="Edificio Miramar Ski"></figure>
      <div class="text">
