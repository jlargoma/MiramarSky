		...
		<div class="row clearfix  push-30">
			...
			<div class="col-xs-12 col-md-6 clearfix center">
				...
				<div class="col-md-12 push-0 not-padding-mobile">
					<?php if ($typeApto == 1): ?>
						@include('new.frontend.pages._infoAptoLujo')
					<?php elseif($typeApto == 2): ?>
						@include('new.frontend.pages._infoAptoStandard')
					<?php elseif($typeApto == 3): ?>
						@include('new.frontend.pages._infoEstudioLujo')
					<?php elseif($typeApto == 4): ?>
						@include('new.frontend.pages._infoEstudioStandard')
					<?php endif ?>
				</div>
