...
<meta name="robots" content="noimageindex">
        ...
        <link rel="stylesheet" type="text/css" href="{{ assetNew('/frontend/css/animate.css')}}">
        <link rel="stylesheet" type="text/css" href="{{ assetNew('/frontend/css/magnific-popup.css')}}">

        <?php if ($mobile->isMobile() || $mobile->isTablet()): ?>
            <link rel="stylesheet" href="{{ assetNew('/frontend/css/responsive-mobile.css')}}" type="text/css"/>
        <?php else: ?>
            <link rel="stylesheet" href="{{ assetNew('/frontend/css/responsive.css')}}" type="text/css"/>
        <?php endif; ?>

        <link rel="stylesheet" href="{{ asset('/new-asset/frontend/colors.php?color=3F51B5')}}" type="text/css"/>

        <link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"/>

        <link rel="stylesheet" type="text/css" href="{{ assetNew('/frontend/include/rs-plugin/css/settings.css')}}">
        <link rel="stylesheet" type="text/css" href="{{ assetNew('/frontend/include/rs-plugin/css/layers.css')}}">
        <link rel="stylesheet" type="text/css" href="{{ assetNew('/frontend/include/rs-plugin/css/navigation.css')}}">

        <link rel="stylesheet" href="{{ assetNew('/frontend/css/font-icons.css')}}" type="text/css"/>

        <link rel="stylesheet" href="{{ assetNew('/frontend/css/aos.css')}}" type="text/css"/>

        <link rel="stylesheet" href="{{ assetNew('/frontend/css/components/daterangepicker.css')}}" type="text/css"/>

        <link href="{{ assetNew('/frontend/hover.css')}}" rel="stylesheet" media="all">
        <link rel="stylesheet" href="{{ assetNew('/frontend/css/components/radio-checkbox.css')}}" type="text/css"/>
        <link rel="stylesheet" href="{{ assetNew('/frontend/custom.css')}}" type="text/css"/>

        <link rel="stylesheet" type="text/css" href="{{ assetNew('/frontend/css/normalize.css')}}" />
        {{--<link rel="stylesheet" type="text/css" href="{{ /css/fourBoxSlider.css')}}" />--}}
        <link rel="stylesheet" type="text/css" href="{{ assetNew('/frontend/css/fourBoxSlider.min.css')}}" />
        <link rel="stylesheet" type="text/css" href="{{ assetNew('/frontend/css/component.css')}}" />    
        <link rel="stylesheet" type="text/css" href="{{ assetNew('/frontend/css/styles.css')}}" />    
        <script type="text/javascript" src="{{ assetNew('/frontend/js/jquery-2.1.4.js')}}"></script><script src="{{assetNew('/frontend/js/modernizr.custom.js')}}"></script>
...
<body class="stretched not-dark" data-loader="5">
    ...
    <div id="" class="clearfix">
        ...
        @include('new.layouts._header')

        @include('new.frontend.slider')
    ...
    @include('new.layouts._generalScriptsFront')
     @yield('moreScripts')
