...
<head>
	...
	@yield('css')
		<script type="text/javascript" src="{{ assetNew('/frontend/js/jquery.js') }}"></script>
...
<body class="stretched no-transition">
	...
	<script type="text/javascript" src="{{assetNew('/frontend/js/components/moment.js')}}"></script>
	<script type="text/javascript" src="{{assetNew('/frontend/js/components/daterangepicker.js')}}"></script>
